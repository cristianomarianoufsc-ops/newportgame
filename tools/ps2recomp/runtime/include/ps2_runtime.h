...
/* Dynamic dispatch — generated by the recompiler in output.c.
 * Called by jalr (indirect function call via register). */
void ps2_dispatch(PS2Regs* regs, uint32_t addr);
